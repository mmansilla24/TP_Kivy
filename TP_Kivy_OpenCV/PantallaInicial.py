...
class PantallaIngreso(Screen):
    ...
    def __init__(self, **kwargs):
        ...
        self.label = Label(text="Registro de ingreso.", size_hint_y=None, height=30)
        ...
        boton_login = Button(text="Ingreso", size_hint=(None, None), size=(100, 50))
        boton_login.bind(on_press=self.validar_captura)
        botones_layout.add_widget(boton_login)

        boton_login = Button(text="Crear Usuario", size_hint=(None, None), size=(100, 50))
